...
# печать Газировка и {ДОБАВКА} в случае наличия добавки, а иначе отобразится следующая фраза: Обычная газировка.

class Soda:
    def __init__(self, ingredient = None):
        if isinstance(ingredient, str): # Если существует строковой добавка
