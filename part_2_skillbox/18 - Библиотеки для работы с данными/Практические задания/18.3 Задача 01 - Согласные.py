...
# Первый содержит все слова, которые начинаются на гласную букву латинского алфавита (в этот раз слово может состоять
# и из одной буквы, например I).
...
# Ещё небольшая подсказка: посмотрите, чем отличается символ * от символа +. Также, когда будете получать второй
# список, обратите внимание, на какой символ начинаются слова.
...
print(f'Слова на гласную: {re.findall(r'\b[aeiouyAEIOUY]\w*', text)}')
print(f'Слова на любой символ, кроме гласной: {re.findall(r"\b[^aeiouyAEIOUY\W]\w*", text)}')